...
// Note that if we execute this script so far, nothing is printed.
// We need to actually call a function in order for its code block to be executed:

sayHello();

// If we now call it multiple times, the message will also appear multiple times:
...
// referencing a functional block of code, so we can call it by a name. It's like
// a little assistant for us who every time we call his name, he executes his
// assigned task. 